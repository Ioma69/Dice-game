...
function changeNames() {
  if (
    inputNameOne.value.length <= 6 &&
    inputNameTwo.value.length <= 6 &&
    inputNameOne.value !== "" &&
    inputNameTwo.value !== ""
  ) {
    ...
    inputNameTwo.value.length > 6 ||
    inputNameOne.value === "" ||
    inputNameOne.value === null ||
    inputNameTwo.value === "" ||
    inputNameTwo.value === null
  ) {
...
function rollDice() {
  diceFaces.animate(
    [{ rotate: "50deg" }, { rotate: "-25deg" }, { rotate: "25deg" }],
    {
      duration: 100,
      iterations: 1,
    }
